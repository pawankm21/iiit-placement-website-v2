...
export default function BaseFooter() {
  return (
    <div className="bg-black text-white w-100 position-absolute bottom-0 ">
      <Container className="p-5">
        <div className="row ">
          <div className="col-3 d-md-block d-none text-start">
          ...
          <div className="col-9 d-md-block d-none text-center">
            <div className="row gap-5">
              <div className="col-4 col d-md-block d-none text-start">
